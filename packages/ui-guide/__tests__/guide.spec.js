import Guide from '../src/main'
import assert from 'assert'
import { cleanDom, sleep } from 'tests/helper'
import WorkBasic from 'tests/components/basic.vue'
import WorkElement from 'tests/components/element.vue'
...
describe('guide', () => {
    ...
    it('target不存在', async () => {
        ...
        assert.strictEqual(wrapperBasic.attributes('top'), '0')
        assert.strictEqual(wrapperBasic.attributes('left'), '0')
        assert.strictEqual(wrapperBasic.attributes('width'), '0')
        assert.strictEqual(wrapperBasic.attributes('height'), '0')
    })
