...
const styles = (styled: any, css: any) => {
  return {
    ...
    Container: styled('div', (props: StyleProps) => `
      ...
      box-sizing: border-box;
    `),
    Button: styled('div', { disabled: Boolean }, (props: StyleProps) => `
      flex: 1;
      height: 60px;
      display: flex;
      align-items: center;
...
export default class BtnPay extends Vue {
  render () {
    const { Root, Container, Button, Prefix, Title, Group, Tip, Desc } = this.styledComponents
    ...
    return (
      <Root>
        ...
        <Button ref="btn" class="tm-btnpay-btn" style={ this.btnStyle } disabled={ this.disabled } on-click={ this.handleClick }>
          { DomButtonContent }
        </Button>
      </Root>
    )
