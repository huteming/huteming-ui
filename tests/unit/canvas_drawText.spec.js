    ...
    describe('drawText', () => {
        ...
        it('不换行 && 超出最长限制', () => {
            ...
            const options = {
                ...
                wrap: false,
                maxWidth: 210,
                prefix: _prefix, // 占据宽度 119
                suffix: _suffix, // 占据宽度 113
                fix: _fix, // 占据宽度 50
            }
            const _text1 = '测' // 占据宽度48
            const _text2 = '试' // 占据宽度48
            const _text3 = '用' // 占据宽度 48
            const _text4 = '例' // 占据宽度 48
            ins.drawText(`${_text1}${_text2}${_text3}${_text4}`, _x, _y, options) // 占据宽度 192
        ...
        it('换行', () => {
            ...
            const _text1 = '测' // 占据宽度 48
            const _text2 = '试' // 占据宽度 48
            const _text3 = '用' // 占据宽度 48
            const _text4 = '例' // 占据宽度 48
            ins.drawText(`${_text1}${_text2}${_text3}${_text4}`, _x, _y, options) // 占据宽度 192
